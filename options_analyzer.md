<div>
    ...
    <p style="text-indent: 15px;">
        Users can define up to four legs in their options strategy, specifying details such as quantity, buy/sell, type (call/put), strike, expiration, risk-free rate, current option price, and original option costs. 
